  ...
  return (
    <section id="projetos" className="py-32 px-6 bg-dark-800/30">
      <div className="max-w-5xl mx-auto">
        <h2 className="section-title text-4xl md:text-5xl mb-6 text-center">Projetos de IA</h2>
        <p className="text-gray-400 text-center mb-16 max-w-2xl mx-auto">
          Sistemas construídos com RAG, agentes LLM e automações — do problema à produção
        </p>
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-purple-deep/30 bg-purple-deep/10 px-6 py-4">
          <svg className="w-5 h-5 text-purple-light shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          <p className="text-gray-400 text-sm">
            Também tenho projetos de IA desenvolvidos em ambiente corporativo —{' '}
            <span className="text-purple-light">RAG pipelines, sistemas multi-agente e automações</span>{' '}
            — que não podem ser divulgados por questões de confidencialidade.
          </p>
        </div>

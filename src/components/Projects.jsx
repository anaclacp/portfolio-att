  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-5 gap-3">
        <div className="w-9 h-9 rounded-lg bg-purple-light/10 border border-purple-light/20 text-purple-light flex items-center justify-center shrink-0">
        ...
        {project.github ? (
          <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-purple-light transition-colors">
          ...
          <span className="text-xs font-mono text-purple-light bg-purple-light/10 border border-purple-light/20 px-3 py-1 rounded-full whitespace-nowrap flex items-center gap-1.5">
      ...
      {/* Title */}
      <h3 className="font-display text-lg font-semibold mb-3 tracking-tight group-hover:text-purple-light transition-colors">
        {project.title}
      </h3>
      ...
      {isRestricted && project.note && (
        <p className="text-gray-500 text-xs italic mt-auto pt-3 border-t border-white/5">
          {project.note}
        </p>
      )}
    </div>

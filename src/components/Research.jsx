  ...
  return (
    <div className="card-glow rounded-2xl overflow-hidden grid md:grid-cols-5 gap-0">
      ...
      <div className="md:col-span-3 p-8 flex flex-col justify-center">
        <span className="text-purple-light text-xs font-mono uppercase tracking-wider mb-2">{item.type}</span>
        <h3 className="font-display text-xl md:text-2xl font-semibold mb-3 tracking-tight">{item.title}</h3>
        <p className="text-gray-400 mb-4 leading-relaxed text-sm md:text-base">{item.description}</p>
        <p className="text-gray-500 text-sm mb-6">
          <span className="text-purple-light/70">·</span> {item.institution}
        </p>
        ...
        <div className="flex flex-wrap items-center gap-5">
          {item.github && (
            <a
              ...
              className="inline-flex items-center gap-2 text-purple-light hover:text-white transition-colors w-fit text-sm"
            >

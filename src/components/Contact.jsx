const contactLinks = [
  {
    ...
    href: "mailto:anaclaracarnavalli@gmail.com",
    label: "anaclaracarnavalli@gmail.com",
    color: "from-pink-soft to-pink-vibrant"
  },
  {
    name: "LinkedIn",
    icon: (
    ...
    href: "https://www.linkedin.com/in/ana-clara-pereira-51264a21a/",
    label: "Ana Clara Pereira",
  ...
  },
  {
    ...
    label: "@anaclacp",
    color: "from-purple-soft to-pink-magenta"
  },
  {
    name: "ArcCode",
    icon: (
    ...
    label: "Meu perfil ArcCode",
    color: "from-pink-vibrant to-purple-deep"
  }
]
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        ...
        <p className="text-white font-medium group-hover:text-pink-vibrant transition-colors">
          {link.label}
        </p>
      </div>
    </a>
  ...
  return (
    <section id="contato" className="py-32 px-6 bg-dark-800/30">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="section-title text-4xl md:text-5xl mb-6">Vamos Conversar?</h2>
        <p className="text-gray-400 mb-16 max-w-xl mx-auto">
          Estou sempre aberta a novas oportunidades, colaborações e projetos interessantes.
        </p>

  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-4xl text-center">
        ...
        <div className="mb-8">
          <BlurText
            text="AI Engineer & Software Developer"
            delay={600}
        ...
        <div className="flex flex-wrap gap-4 justify-center slide-up" style={{ animationDelay: '1000ms' }}>
          ...
          <a
            ...
            className="px-8 py-3 rounded-full font-body font-medium border border-purple-light/50 hover:border-pink-vibrant transition-colors flex items-center gap-2"
          >

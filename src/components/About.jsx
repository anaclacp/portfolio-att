  ...
  return (
    <section id="sobre" className="py-32 px-6">
      <div className="max-w-3xl mx-auto">
        <h2 className="section-title text-3xl md:text-4xl mb-12 text-center" data-reveal>
        ...
        <div className="space-y-5 text-gray-300 font-body text-center md:text-left">
          <p className="text-base md:text-lg leading-relaxed" data-reveal>
            {t.about.p1Before}
          ...
          <p className="text-base md:text-lg leading-relaxed" data-reveal style={{ '--reveal-delay': '80ms' }}>
            {t.about.p2}
          </p>
          <p className="text-base md:text-lg leading-relaxed text-gray-400" data-reveal style={{ '--reveal-delay': '160ms' }}>
            {t.about.p3Before}
            <span className="text-purple-light">{t.about.p3Highlight}</span>
            {t.about.p3After}
          </p>
          <p className="text-base md:text-lg leading-relaxed text-gray-400" data-reveal style={{ '--reveal-delay': '240ms' }}>
            {t.about.p4}
          </p>
        </div>
      </div>

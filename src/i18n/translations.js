export const translations = {
  pt: {
    ...
    hero: {
      ...
      description:
        'Engenheira da Computação e desenvolvedora de sistemas de IA, com experiência em Python, IA generativa, agentes e aplicações end-to-end, atualmente atuando com Responsible AI.',
    ...
    contact: {
      ...
      learningLabel: 'Estudos, livros e leituras',
    },
    ...
    learning: {
      metaTitle: 'Learning Log | Ana Clara Pereira',
      metaDescription:
        'Estudos, livros, pesquisas e projetos que Ana Clara Pereira vem explorando em Inteligência Artificial, engenharia de software e tecnologia.',
      backToHome: 'Voltar ao portfólio',
      title: 'Learning',
      titleAccent: 'Log',
      subtitle:
        'Estudos, livros, artigos e experimentos que venho explorando.',
      sections: {
        current: 'Atualmente estudando',
        bookshelf: 'Bookshelf',
        readings: 'Artigos & Leituras',
        recent: 'Estudos recentes',
        projects: 'Experimentos & Projetos',
        timeline: 'Linha do tempo',
      },
      currentlyReading: 'Atualmente lendo',
      openReading: 'Abrir leitura',
      openPaper: 'Abrir paper',
      openDocs: 'Abrir documentação',
      cta: 'Veja o que estou estudando',
      ctaHint: 'Um registro público do que ando estudando, lendo e pesquisando.',
      relatedProject: 'Projeto relacionado',
      startedAt: 'Início',
      completedAt: 'Concluído',
      showMore: 'Ver mais',
      showLess: 'Ver menos',
      noProgress: 'Sem progresso registrado',
      by: 'por',
      loading: 'Carregando...',
      empty: {
        current: 'Nada em andamento no momento.',
        recent: 'Nenhum assunto estudado registrado ainda.',
        bookshelf: 'A estante ainda está vazia.',
        readings: 'Nenhum artigo ou paper registrado ainda.',
        projects: 'Nenhum experimento registrado ainda.',
        all: 'O Learning Log ainda não tem registros.',
      },
      error: {
        title: 'Não foi possível carregar o Learning Log',
        retry: 'Tentar de novo',
        notConfigured:
          'O banco de dados ainda não foi conectado. Configure DATABASE_URL para os registros aparecerem aqui.',
      },
      types: {
        study: 'Estudo',
        book: 'Livro',
      ...
      // Rotulo padrao de cada status.
      statuses: {
        studying: 'Estudando',
        explored: 'Estudado recentemente',
        reading: 'Lendo',
        finished: 'Concluído',
        read: 'Lido',
      ...
      // Só o que muda de sentido conforme o tipo. O resto cai no padrão acima.
      statusByType: {
        study: { planned: 'Quero estudar' },
        research: { planned: 'Quero estudar' },
        project: { studying: 'Em construção', explored: 'Pausado por ora' },
      },
    },

    admin: {
      metaTitle: 'Admin · Learning Log',
      title: 'Learning Log',
      titleAccent: 'admin',
      subtitle: 'Adicione, edite e acompanhe os registros de estudo.',
      viewPublic: 'Ver página pública',
      login: {
        title: 'Painel protegido',
        description: 'Informe o token de administração para continuar.',
        label: 'Token',
        submit: 'Entrar',
        invalid: 'Token inválido.',
        notConfigured: 'ADMIN_TOKEN não está configurada no servidor.',
      },
      logout: 'Sair',
      newItem: 'Novo estudo',
      editItem: 'Editar estudo',
      fields: {
        title: 'Título',
        type: 'Tipo',
        status: 'Status',
        ...
        repositoryUrl: 'Repositório',
        coverUrl: 'Capa (URL da imagem)',
      ...
      actions: {
        ...
        confirmRemove: 'Excluir este registro? Essa ação não pode ser desfeita.',
      },
      list: {
        title: 'Registros',
        empty: 'Nenhum registro ainda. Crie o primeiro no formulário ao lado.',
      },
      feedback: {
  ...
  en: {
    ...
    contact: {
      ...
      learningLabel: 'Studies, books and readings',
    },
    ...
    learning: {
      metaTitle: 'Learning Log | Ana Clara Pereira',
      metaDescription:
        'Studies, books, research and projects Ana Clara Pereira has been exploring in Artificial Intelligence, software engineering and technology.',
      backToHome: 'Back to portfolio',
      title: 'Learning',
      titleAccent: 'Log',
      subtitle:
        'Studies, books, articles and experiments I have been exploring.',
      sections: {
        current: 'Currently learning',
        bookshelf: 'Bookshelf',
        readings: 'Articles & Readings',
      ...
      openDocs: 'Open docs',
      cta: 'See what I am studying',
      ctaHint: 'A public record of what I am studying, reading and researching.',
      ...
      loading: 'Loading...',
      empty: {
        current: 'Nothing in progress right now.',
        recent: 'No explored topics recorded yet.',
        bookshelf: 'The shelf is still empty.',
        readings: 'No articles or papers recorded yet.',
        projects: 'No experiments recorded yet.',
        all: 'The Learning Log has no entries yet.',
      },
      error: {
        title: 'Could not load the Learning Log',
        retry: 'Try again',
        notConfigured:
          'The database is not connected yet. Set DATABASE_URL for entries to show up here.',
      },
      types: {
        study: 'Study',
        book: 'Book',
      ...
      statusByType: {
        study: { planned: 'Want to study' },
        research: { planned: 'Want to study' },
        project: { studying: 'Building', explored: 'On hold' },
      },
    },
    ...
    admin: {
      ...
      title: 'Learning Log',
      titleAccent: 'admin',
      subtitle: 'Add, edit and track your study entries.',
      viewPublic: 'View public page',
      login: {
        title: 'Protected panel',
        description: 'Enter the admin token to continue.',
        label: 'Token',
        submit: 'Sign in',
        invalid: 'Invalid token.',
        notConfigured: 'ADMIN_TOKEN is not configured on the server.',
      },
      logout: 'Sign out',
      newItem: 'New entry',
      editItem: 'Edit entry',
      ...
      actions: {
        ...
        confirmRemove: 'Delete this entry? This cannot be undone.',
      },
      list: {
        title: 'Entries',
        empty: 'No entries yet. Create the first one in the form beside.',
      },
      feedback: {
